...
console.log("\n— language & theme —");
{
  ...
  const waveFill = () =>
    // The page-coloured layer of the hero wave (the other layer is a faint
    // white swell that never changes).
    page.getAttribute("section > svg[aria-hidden='true'] path[data-page-fill]", "fill");

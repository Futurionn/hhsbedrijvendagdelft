  ...
  return (
    <div>
      <div className="relative">
        <div className="relative overflow-hidden rounded-sm border border-navy/15 bg-white dark:border-white/15 dark:bg-slate-900/40">
            ...
            {hotspots.map((hotspot) => {
              ...
              return (
                <button
                  key={hotspot.id}
                  type="button"
                  className={`absolute rounded-sm border transition-[background-color,border-color,box-shadow] duration-press ${
                    isActive
        ...
        {activeHotspot ? (
          <div
            className="pointer-events-none absolute z-20 max-w-[75vw] -translate-x-1/2 -translate-y-[115%] rounded-sm bg-navy-deep/90 px-3 py-2 text-caption text-white shadow-lg shadow-black/30 backdrop-blur-sm"
            style={{
              left: toPercent(

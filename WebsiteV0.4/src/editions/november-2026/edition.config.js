...
export const NOVEMBER_2026_CONTENT = {
  ...
  /**
   * The huge, faint date at the very bottom of the page, cropped by the
   * footer. Purely graphic; screen readers skip it. Set to null to remove it.
   */
  bigDate: "26.11.26",
   ...
   * `tone`: "navy" for the day itself, "orange" for the borrel.
    ...
    lanes: [
      {
        ...
        title: { nl: "Bedrijvendag", en: "Career day" },
        body: {
          nl: "Loop langs de stands, stel je vragen en spreek recruiters en engineers van de deelnemende bedrijven.",
          en: "Visit the stands, ask your questions, and talk to recruiters and engineers from the participating companies."
        }
      },
      {
        from: "16:00",
        ...
        body: {
          nl: "Het informele deel van de dag, met een drankje erbij.",
          en: "The informal half of the day, with a drink in hand."
        }
      }
    ]
  },

...
//  a line. Hovering one lane fades the others (.tl-lanes in index.css). On
//  phones the axis goes and each lane becomes a row with a coloured left
//  border and its own time — everything readable without hover.
//
        ...
        <SectionMain>
          ...
          {companies ? (
            <Link
              ...
              className="bizlink mt-[clamp(2rem,4vw,3.5rem)] grid grid-cols-1 items-center gap-4 border-b border-t border-b-rule border-t-rule-strong py-8 dark:border-b-white/15 dark:border-t-white/70 tab:grid-cols-[1fr_auto]"
            >
              <div>

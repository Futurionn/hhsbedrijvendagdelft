...
function FeatureCard({ icon: Icon, title, body }) {
  return (
    <div className="group rounded-3xl bg-gray-50 p-7 transition-all duration-500 hover:bg-navy hover:shadow-lg hover:shadow-[#909806]/15 dark:bg-white/5 dark:hover:bg-navy">

...
function AssociationCard({ item }) {
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="group block rounded-3xl border border-white/10 bg-white/5 p-7 shadow-lg shadow-black/20 backdrop-blur-sm transition-all duration-500 hover:bg-white/10 hover:shadow-[#909806]/10"
    >

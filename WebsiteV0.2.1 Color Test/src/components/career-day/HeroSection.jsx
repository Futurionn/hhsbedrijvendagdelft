        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex flex-col items-end gap-2">
            <button
              ...
              className="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 text-sm font-semibold text-white/90 backdrop-blur-sm transition-all duration-500 hover:bg-white/15 hover:shadow-lg hover:shadow-[#909806]/25"
        ...
        >
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-3 md:flex-row">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group relative inline-flex items-center gap-3 rounded-full bg-white/10 px-5 py-3 text-white/90 backdrop-blur-sm transition-all duration-500 hover:bg-white/15 hover:shadow-lg hover:shadow-[#909806]/20"
            >
          ...
          <div className="mt-10">
            <button
              type="button"
              onClick={goCompanies}
              className="inline-flex items-center justify-center rounded-full bg-orange px-10 py-4 font-semibold text-white shadow-lg shadow-[#909806]/30 transition-all duration-500 hover:scale-105 hover:shadow-[#909806]/45"
            >
              {t.ctaDiscover}
            </button>
          </div>

    ...
    <div className="overflow-hidden rounded-2xl border border-gray-100 bg-white p-5 shadow-sm shadow-black/5 dark:border-white/10 dark:bg-slate-900 dark:shadow-black/40">
      <div className="grid gap-4 sm:grid-cols-[140px_1fr_auto] sm:items-start">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex items-center gap-2 justify-self-start rounded-full bg-orange px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-[#909806]/20 transition-all duration-500 hover:scale-105 sm:justify-self-end"
        >
          {websiteLabel}

...
export default function HhsLogo({ size = "hero" }) {
  ...
  return (
    <Link
      ...
      className="inline-flex shrink-0 rounded-lg transition-opacity duration-settle ease-settle hover:opacity-80 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/70 focus-visible:ring-offset-2 focus-visible:ring-offset-navy"
    >
      <img
        src="/HHS/HHS.png"
        alt={t.hhsLogoAlt}

  ...
  return (
    <footer className="bg-navy text-white">
      <m.div {...reveal} className="mx-auto max-w-6xl px-6 py-16">
        {showCta ? <div className="rounded-3xl bg-white/5 p-10 text-center backdrop-blur-sm">
        ...
        <div className={`${showCta ? "mt-16 " : ""}grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4`}>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-white/70">
              ...
              <li>
                ...
                >
                  {lang === "nl" ? "Voor bedrijven" : "For companies"}
                </Link>
              </li>
            </ul>
          </div>

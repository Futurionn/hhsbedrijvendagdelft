  ...
  const items =
    lang === "nl"
      ? [
          ...
          {
            q: "Wie heeft deze website gemaakt?",
            a: (
              <>
                Deze website is in 2026 gemaakt door Mathis Gesquiere, in de functie van
                voorzitter van S.V. Rheon. Bekijk zijn profiel via{" "}
                <a
                  className="font-semibold text-orange"
                  href="https://linkedin.com/in/mathis-g"
                  target="_blank"
                  rel="noreferrer"
                >
                  linkedin.com/in/mathis-g
                </a>
                .
              </>
            )
      ...
      : [
          ...
          },
          {
            ...
            a: (
              <>
                This website was created in 2026 by Mathis Gesquiere, in his role as
                president of S.V. Rheon. View his profile via{" "}
                <a
                  className="font-semibold text-orange"
                  href="https://linkedin.com/in/mathis-g"
                  target="_blank"
